...
var osm_ciclo = L.tileLayer('http://{s}.tile-cyclosm.openstreetmap.fr/cyclosm/{z}/{x}/{y}.png');
...
omnivore.kml('datos/hoteles.kml', null, hoteles).bindPopup(function (layer){
            return "<b>Nombre:</b> "+layer.feature.properties.Nombre+"<br><b>Estrellas:</b> "+layer.feature.properties.Estrellas;   
}).addTo(map);
